  ...
  return (
    <div className='w-[100%]'>
        ...
        <div className='flex flex-col items-center gap-2 py-4 lg:gap-3.5 lg:pb-10 lg:pt-5'>
          ...
          <div className='lg:gap-4.5 flex flex-wrap justify-center gap-1 text-sm'>
            <div className='gap-1.25 flex items-center'>
              <i className='ki-filled ki-abstract-41 static text-sm text-gray-500' />
              <span className='text-gray-600'>Frontend Developer</span>
            </div>
            <div className='gap-1.25 flex items-center'>
              <i className='ki-filled ki-geolocation text-sm text-gray-500' />
              <span className='text-gray-600'>Hyderabad</span>
            </div>
            <div className='gap-1.25 flex items-center'>
              <i className='ki-filled ki-sms text-sm text-gray-500' />
              <Link
                href='mailto:vmagendran@caci.co.uk'
      ...
      <div className='w-[100%] pt-3'>
        <div className='container-fixed dark:border-b-coal-100 mb-5 flex flex-nowrap items-center justify-between gap-6 border-b border-b-gray-200 lg:mb-10 lg:items-end'>
          <div className='grid'>
            <div className='scrollable-x-auto static'>
              <div className='menu gap-3'>
                {PROFILE_HEADER_ITEMS.map(({ name, path }) => {
                  return (
                    <div
                      key={path}
                      className={` ${
